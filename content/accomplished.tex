...
\begin{itemize}
	\item Fixed semantic version of redoxer and applied missing argument for a function to fix compiler failure \cite{pr_bump_fix_redoxer}.
\end{itemize}
...
\begin{itemize}
	\item Requested the rebuilding of the docker image for redoxer so that the Ion Shell repository can be build with a new rust version \cite{issue_request_new_docker_version}.
\end{itemize}

\subsection{Still Opened Isssues}
